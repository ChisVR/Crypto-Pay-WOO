...
const DOGEC_API_URL = "https://payment-checker.chisdealhd.co.uk/";
...
function dogec_verify_payment()
{
    ...
    $response = wp_remote_get(DOGEC_API_URL . "DOGEC.php?address=" . $payment_address . "&tx=" . $transaction_id . "&amount=" . $order_in_crypto . "&conf=" . $confirmation_no . "&otime=" . $order_time . "&mtime=" . $max_time_limit . "&pv=" . $plugin_version);
